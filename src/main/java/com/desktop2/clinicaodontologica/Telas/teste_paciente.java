 ...
 * @author clara
 */
public class teste_paciente extends javax.swing.JFrame {

    /**
     * Creates new form teste_paciente
     */
    public teste_paciente() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jPanel2.setBackground(new java.awt.Color(250, 0, 102));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(teste_paciente.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new teste_paciente().setVisible(true);
            }
        });
    }
